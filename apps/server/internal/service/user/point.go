...
type IPointLogic interface {
	Account(ctx context.Context, userId int64) (*PointAccountView, error)
	Logs(ctx context.Context, userId int64, bizType int, page PageQuery) (*PageResult[PointLogItem], error)
