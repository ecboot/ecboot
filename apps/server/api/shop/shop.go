...
type IShopV1 interface {
	...
	AssistLaunch(ctx context.Context, req *v1.AssistLaunchReq) (res *v1.AssistLaunchRes, err error)
	AssistProgress(ctx context.Context, req *v1.AssistProgressReq) (res *v1.AssistProgressRes, err error)
	AssistHelp(ctx context.Context, req *v1.AssistHelpReq) (res *v1.AssistHelpRes, err error)
	...
	BargainLaunch(ctx context.Context, req *v1.BargainLaunchReq) (res *v1.BargainLaunchRes, err error)
	BargainProgress(ctx context.Context, req *v1.BargainProgressReq) (res *v1.BargainProgressRes, err error)
	BargainCut(ctx context.Context, req *v1.BargainCutReq) (res *v1.BargainCutRes, err error)
