...
CREATE TABLE `ad_custom` (
  ...
  `ad_status` int(11) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`ad_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `article_cat` (
  ...
  `sort_order` int(11) unsigned NOT NULL DEFAULT '50',
...
CREATE TABLE `back_order` (
  ...
  `shipping_id` int(11) unsigned DEFAULT '0',
...
CREATE TABLE `bonus_type` (
  ...
  `send_type` int(11) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `cart` (
  ...
  `can_handsel` int(11) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `comment` (
  ...
  `comment_type` int(11) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `crons` (
  ...
  `cron_desc` text,
  `cron_order` int(11) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `favourable_activity` (
  ...
  `act_range` int(11) unsigned NOT NULL,
  `act_range_ext` varchar(255) NOT NULL,
  `min_amount` decimal(10,2) unsigned NOT NULL,
  `max_amount` decimal(10,2) unsigned NOT NULL,
  `act_type` int(11) unsigned NOT NULL,
...
CREATE TABLE `friend_link` (
  ...
  `show_order` int(11) unsigned NOT NULL DEFAULT '50',
  PRIMARY KEY (`link_id`),
...
CREATE TABLE `goods` (
  ...
  `warn_number` int(11) unsigned NOT NULL DEFAULT '1',
  `keywords` varchar(255) NOT NULL DEFAULT '',
  ...
  `is_real` int(11) unsigned NOT NULL DEFAULT '1',
  `extension_code` varchar(30) NOT NULL DEFAULT '',
  ...
  `bonus_type_id` int(11) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `goods_activity` (
  ...
  `start_time` int(11) unsigned NOT NULL,
  `end_time` int(11) unsigned NOT NULL,
  `is_finished` int(11) unsigned NOT NULL,
...
CREATE TABLE `payment` (
  ...
  `pay_order` int(11) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `reg_fields` (
  ...
  `dis_order` int(11) unsigned NOT NULL DEFAULT '100',
...
CREATE TABLE `shipping` (
  ...
  `shipping_order` int(11) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `snatch_log` (
  `log_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `snatch_id` int(11) unsigned NOT NULL DEFAULT '0',
  `user_id` int(11) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `users` (
  ...
  `is_validated` int(11) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `vote_option` (
  ...
  `option_count` int(11) unsigned NOT NULL DEFAULT '0',
  `option_order` int(11) unsigned NOT NULL DEFAULT '100',
