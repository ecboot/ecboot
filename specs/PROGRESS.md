...
| 06 | `specs/012-trade-wiring` | 交易闭环连线（shop 购物车/订单/支付 + admin 订单发货/取消/备注 + user 优惠券） | 22 | 02 03 04 | 混合：连线（cart/order C 端）+ 新写（pay 5/coupon 6/admin order 5/confirm 1）+ **前置修积分 bug** | 🔶 | |
