...
|---|---|---|---|---|---|---|---|
| 01 | `specs/007-admin-base` | 后台账户与系统配置（登录/登出/刷新/资料/改密、admin_user、RBAC 角色、config、ping/短信调试桩） | 22 | — | 接口已有，impl 待补 | 🔶 | |
...
| 2026-09-21 | 01 | spec 假设修订：允许新增纯数据种子迁移 000035_admin_seed（超管账号 1 个） | 勘察发现无种子管理员，后台无可登录入口；plan/research D3 | |
